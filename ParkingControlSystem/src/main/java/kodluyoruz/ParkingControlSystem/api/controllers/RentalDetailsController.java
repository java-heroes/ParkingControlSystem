...
public class RentalDetailsController {
	...
	@GetMapping("/getByParkRentalId")
	public DataResult<RentalDetail> getByParkRentalId(@RequestParam Integer parkRentalId){
		return this.getByParkRentalId(parkRentalId);
	}
